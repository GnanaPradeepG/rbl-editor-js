...
//   TO ACCESS THE SELETCED OPTION'S TEXT
// let BRType;
// function textToTextArea (e) {
//     e = e || window.event;
//     var text = 'textContent' in document ? 'textContent' : 'innerText';
//     BRType = e.target[text];
//     console.log(BRType)
// }

// var list = document.getElementById('BRtype');
